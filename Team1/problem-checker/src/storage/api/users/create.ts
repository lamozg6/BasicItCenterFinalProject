import { IUser_create_Storage_Args, IUser_ResBody } from '../../../common/types/user.types';
import { UserEntity } from '../../db/entities/User.entity';
import { transform } from './transformer';
import { generateDateInsertPSQLCommand } from '../../../utils/helpers/dateUtils';


export async function create(args: IUser_create_Storage_Args): Promise<IUser_ResBody> {
  const {
    id,
    name,
    surname,
